        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response && (response.steam || response.epic)) {
            ...
            function renderPrices(data) {
                ...
                // Processar Steam
                if (data.steam && data.steam.results && data.steam.results.length > 0) {
                    html += createPlatformSection('Steam', 'https://store.steampowered.com/favicon.ico', data.steam.results);
                }
                    ...
                    <div class="price-item">
                        ...
                        <div class="price-link">
                            <a href="${item.url}" target="_blank" class="btn btn-sm btn-primary">
                                Comprar <i class="fas fa-external-link-alt ms-1"></i>
                            </a>
                        </div>
                    </div>
                `;
